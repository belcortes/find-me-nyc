...
public class DemoApplicationTests {
	...
	public void shouldAllowFullCrudForAUser() throws Exception {
		...
		when()
				.get("http://app:8080/users/" + secondUser.getId())
				.then()
				.statusCode(is(200))
		...
		given()
				...
				.and().body(secondUser)
				.when()
				.patch("http://app:8080/users/" + secondUser.getId())
				.then()
				.statusCode(is(200))
		...
		when()
				.delete("http://app:8080/users/" + secondUser.getId())
				.then()
				.statusCode(is(200));
